					...
					<div className="col-lg-3 col-12">
						<div className="me-7">
							...
							<p className="text-body-secondary mb-0">
								<a href="tel:+14376855676" className="text-decoration-none text-body-secondary">
									437-685-5676
								</a>
							</p>
						</div>
				...
				<div className="row align-items-center">
					...
					<div className="col-md-9 col-lg-6">
						<div className="small mb-3 mb-lg-0 text-lg-center">
								Copyright © {new Date().getFullYear()} Edmonton Web Developer. All rights reserved.
						</div>
					</div>
					<div className="col-lg-3">
						<div className="text-lg-end d-flex align-items-center justify-content-lg-end">
							...
							<div className="ms-3 d-flex gap-2">
								...
								</a>							<a href="https://wa.me/14376855676" className="btn btn-whatsapp btn-icon" target="_blank" rel="noopener noreferrer">
